...
export async function configure(aurelia) {
    ...
    let contextService = aurelia.container.get(ContextServiceImplementation);
    ...
    let registerServices = [
        ...
        new ModelServiceBasic('device', {apiEntrypoint, uniqueProperty, formats: [...formats, ...['uri', 'ipv4', 'ipv6']], endpoints: {getSchema: getSchemaDevice}, throwOnValidationError: false}, httpService, i18n, eventAggregator),
